describe("MyBiz Overall page", function () {
   ...
   // KPI page 
     it("should Click KPI Overview", function() {
         ST.component('app-main#app-main-1001 tab[iconCls=exec-kpi-icon]').visible().click().getUrl(function(url){
   ...
   it("should Click Perf", function() {
        ST.component('app-main#app-main-1001 tab[iconCls=exec-quarterly-icon]').visible().click().getUrl(function(url){
...
ST.button('cycle[reference=\"filterButton\"] menu > menucheckitem[text=\"News\"]')
 ...
 ST.button('cycle[reference=\"filterButton\"] menu > menucheckitem[text=\"All Posts\"]')
  ...
  it("should Expand 5 news panels", function() {   
    ...
    {
    ST.grid('news').viewReady().rowAt(index).down('.expand').click();
    }
  ...
  it("should collapse 5 news panels", function() {   
    for (index = 0; index <= 5; index++)
    {
